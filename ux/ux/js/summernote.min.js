...
! function (t, e) {
	...
	var Vt = function () {
		...
		ae = function () {
			...
			return e.prototype.initialize = function () {
				var t = this.options.dialogsInBody ? this.$body : this.$editor,
					e = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.10</a> Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
				this.$dialog = this.ui.dialog({
	...
	t.fn.extend({
		...
		options: {
			...
			icons: {
				...
				undo: "fa fa-undo",
				unorderedlist: "fa fa-unorderedlist",
				video: "fa fa-video"
			}
		}
	})
